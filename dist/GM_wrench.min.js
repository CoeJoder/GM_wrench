...
function(a,b,c,e,g){"undefined"===typeof c&&(c=!0);"undefined"===typeof e&&(e=300);"undefined"===typeof g&&(g=-1);var t="function"===typeof a?a():document.querySelectorAll(a),l=t&&0<t.length;l&&t.forEach(function(n){n.getAttribute("data-userscript-alreadyFound")||(b(n)?l=!1:n.setAttribute("data-userscript-alreadyFound",!0))});0===g||l&&c||(--g,setTimeout(function(){GM_wrench.waitForKeyElements(a,b,c,e,g)},e))};GM_wrench.wait=function({condition:a,input:b,timeout:c=0,pollTimeout:e=200,message:g}={}){function t(){return new Promise((f,
m)=>{try{f(n(b))}catch(r){m(r)}})}if("number"!==typeof c||0>c)throw new TypeError("timeout must be a number >= 0: "+c);if("number"!==typeof e||0>e)throw new TypeError("pollTimeout must be a number >= 0: "+e);try{var l=a&&("object"===typeof a||"function"===typeof a)&&"function"===typeof a.then}catch(f){l=!1}if(l)return new Promise((f,m)=>{if(c){var r=Date.now(),p=setTimeout(function(){p=null;try{let h=z(g);m(new k(`${h}Timed out waiting for promise to resolve after ${Date.now()-r}ms`))}catch(h){m(new k(`${h.message}\nTimed out waiting for promise to resolve after ${Date.now()-
r}ms`))}},c);a.then(function(h){p&&clearTimeout(p);f(h)},function(h){p&&clearTimeout(p);m(h)})}else f(a)});let n;if(a instanceof q)g=g||a.description(),n=a.fn;else if("function"===typeof n)n=a;else throw new TypeError("Wait condition must be a promise-like object, function, or a Condition object");l=new Promise((f,m)=>{const r=Date.now(),p=async()=>{t().then(function(h){const x=Date.now()-r;if(h)f(h);else if(c&&x>=c)try{let y=z(g);m(new k(`${y}Wait timed out after ${x}ms`))}catch(y){m(new k(`${y.message}\nWait timed out after ${x}ms`))}else setTimeout(p,
e)},m)};p()});return a instanceof u?new v(l.then(function(f){if(!(f instanceof Element))throw new TypeError("ElementCondition did not resolve to a Element: "+Object.prototype.toString.call(f));return f})):l};d.prototype.toString=function(){return`By(${this.using}, ${this.value})`};GM_wrench.By=d;d.css=function(a){return new d("css",a)};d.id=function(a){return new d("id",a)};d.className=function(a){return new d("className",a)};d.linkText=function(a){return new d("linkText",a)};GM_wrench.Condition=
